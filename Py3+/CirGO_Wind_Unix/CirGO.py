...
class Application(tk.Frame):
    ...
    def __init__(self, master = None, nrCategories = DEFAULT_NUM_OF_CATEGORIES, fontSize = DEFAULT_FONT_SIZE, figureLegend = DEFAULT_LEGEND_NAME):
        ...
        self.nrCategories = tk.IntVar()
        self.fontSize = tk.DoubleVar()
        self.figureLegend = tk.StringVar()
        ...
        #self.frame = tk.Frame.__init__(self, master, relief = RAISED, borderwidth = 2, padx = 2, pady = 2)
        self.frame = tk.Frame.__init__(self, master, borderwidth = 2, padx = 2, pady = 2)
        self.grid()
        self.createWidgets()
    ...
    def createWidgets(self):
        ...
        self.openFileButton.pack(padx = 2, pady = 2)
        ...
        self.batchProcessDirectory.pack(padx = 2, pady = 2)
        ...
        self.visualiseButton.pack( padx = 2, pady = 2)
        ...
        self.closeButton.pack(padx = 2, pady = 2)
        ...
        self.quitButton.pack( padx = 2, pady = 2)
    ...
    def openInputFile(self):
        self.inputFileName = tkinter.filedialog.askopenfilename(title = "Open REVIGO Comma Separated File...", initialdir = (os.path.expanduser('~/')), filetypes = [("csv file","*.csv")], defaultextension = '.csv')
    ...
    def saveOutputFile(self):
        outputFilenameDialogue = tkinter.filedialog.asksaveasfilename(initialdir = "/", title = "Select file", filetypes = [("svg files","*.svg")])
...
# Input File --------------------------------------------------------------------------------------------------------------------
        infl = eval(input("Input file from REVIGO as CSV [str]: "))
        if type(infl) != str:
        ...
        try:
            ...
            sys.exit() 
# Font Size --------------------------------------------------------------------------------------------------------------------
        insize = input("Font Size (Example - 7.0) [float]: ")
        if insize == ""  :
...
# Number of Categories--------------------------------------------------------------------------------------------------------------------
        incat = input("Number of Categories (Example - 40) [int]: ")  #  a string
        if incat == "":
        ...
        try:
            ...
            sys.exit()
# Legend--------------------------------------------------------------------------------------------------------------------
        inleg = input('Legend name. Example: "Name & Proportion of Biological process (inner ring)" [str]: ')
        if inleg == "":
        ...
        try:
            ...
            sys.exit()
# OutputFile--------------------------------------------------------------------------------------------------------------------
        outfl = eval(input("Output file in svg format (Example: input filename + svg) [str]: "))
        if type(outfl) != str:
...
## ----------------------------------------------------------------------------------------------------
## 4. Version control for Pyhton 3+ 
## ----------------------------------------------------------------------------------------------------
