...
```diff
! Note: CirGO Python 2+ was migrated to Python 3+. 
```
...
1. Download  [Anaconda distribution](https://www.anaconda.com/distribution/) also called Anaconda Prompt for Python 2.7 on your Windows machine. 
```diff
